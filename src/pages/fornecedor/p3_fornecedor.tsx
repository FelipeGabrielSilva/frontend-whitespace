...
const validationSchema = Yup.object().shape({
  ...
  cnpj: Yup.string().required("CNPJ é obrigatório").matches(/^\d+$/, "CNPJ deve conter apenas números"),
...
const CadastroFornecedor: React.FC = () => {
  ...
  return (
    <div>
      ...
      <Formik
        initialValues={{ nome: "", cnpj: "", telefone: "", email: "", criadorId: 1 }} // Ajuste os valores iniciais
